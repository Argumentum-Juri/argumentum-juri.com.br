...
interface PetitionDetailComponentProps {
  petitionId: string;
}

const PetitionDetailComponent: React.FC<PetitionDetailComponentProps> = ({ petitionId }) => {
...
export default PetitionDetailComponent;

          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-md">{petition.description}</p>
              </div>
              
              <div>
                <h3 className="text-sm font-medium text-muted-foreground mb-1">Área Jurídica</h3>
                <p className="text-md">{petition.legal_area || 'Não especificada'}</p>
              </div>
              
              <div>
                <h3 className="text-sm font-medium text-muted-foreground mb-1">Tipo de Petição</h3>
                <p className="text-md">{petition.petition_type || 'Não especificado'}</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {petition.has_process && (
                <div>
                  ...
                  <p className="text-md">{petition.process_number || 'Não informado'}</p>
                </div>
              )}
              ...
              {petition.user && (
                <div>
                  ...
                  <p className="text-md">{petition.user.name || petition.user.email || 'Desconhecido'}</p>
                </div>
              )}
              ...
              {!hideId && (
                <div>
                  ...
                  <p className="text-md font-mono">{petition.id}</p>
                </div>
              )}
            </div>
          </div>

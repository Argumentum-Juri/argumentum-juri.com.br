-- Corrigir erro de tipo na função purchase_tokens_idempotent
-- O problema é que ROW_COUNT retorna integer, não boolean
...
BEGIN
  ...
  -- Verifica quantas linhas foram inseridas (integer, não boolean)
